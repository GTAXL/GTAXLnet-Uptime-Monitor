#!/bin/bash
# GTAXLnet Uptime Monitor - main.sh Version: 1.01
...
# By: Victor Coss (GTAXL) vic@likeacoss.com DEC/24/2015
...
runcheckers() { 
	/home/gtaxl/uptimemon/http.sh > /dev/null 2>&1 &
	/home/gtaxl/uptimemon/smtp.sh > /dev/null 2>&1 &
}
